...
//        08 80 00 00 ff ff ff ff ff ff e0 2a 82 43 5b e3 e0 2a 82 43 5b e3 00 00 00 00 00 00 00 00>, LIMIT 1, STOP true, ACTIVE true)
        08 80 00 00 ff ff ff ff ff ff e0 2a 82 43 5b e3 e0 2a 82 43 5b e3 00 00 00 00 00 00 00 00 1f 13 11 12 34 ab cd 00 00 74 65 6d 70 75 6e 69 74 3a 63 65 6c 63 69 75 73>, LIMIT 1, STOP true, ACTIVE true)
	-> SetTXRate(2)
	-> RadiotapEncap()
	-> Print(Ping,254)
	-> ToDevice(wlan0);
